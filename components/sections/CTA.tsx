      ...
      <section className="py-20 relative overflow-hidden bg-gradient-to-br from-navy-800 via-purple-900 to-navy-800">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="#contact"
              className="bg-gradient-to-r from-indigo-600 to-purple-700 text-white font-bold px-10 py-4 rounded-md font-heading text-lg flex items-center gap-2 hover:shadow-[0_0_30px_rgba(99,102,241,0.6)] hover:-translate-y-0.5 transition-all"
            >
              📅 Book a Free Call
            </a>
            <a
