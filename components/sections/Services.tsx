const Services = () => {
    ...
    return (
      <section id="services" className="py-15 bg-gradient-radial from-indigo-500/5 via-transparent to-transparent bg-navy-900">
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-1 xl:px-16">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, idx) => (
              <div key={idx} className="glass-card rounded-2xl p-6 border border-indigo-500/15 bg-white/5 backdrop-blur-md hover:bg-white/10 hover:border-indigo-500/40 hover:-translate-y-1 transition-all duration-300 group">
        ...
        <p className="text-gray-400 text-center max-w-xl pt-7 mx-auto">
              Projects Shows more than Talks.
            </p>
      </section>
    );
  };
